...
class Queue:
    ...
    def printQueue(self):
        ...
        while burstTimeiable!=0:
            print(burstTimeiable.name,'    ',burstTimeiable.arrivalTime,'    ',burstTimeiable.burstTime)
    ...
    def setAllSmall(self,readyQueue,v):
        ...
        while v1!=0:
            if int(v1.arrivalTime)<=v:
                readyQueue.addAtTail(v1.name,v1.arrivalTime,v1.burstTime,v1.quantum,v1.IO_Time)
...
while readyQueue.empty()!=True or newQueue.empty()!=True or waitingQueue.empty()!=True:
    ...
    while c>0:
        ...
        if waitingQueue.empty()!=True:
            waitingQueue.setAllSmall(readyQueue,value)
        if f<=0:
            print('|',a,value)
            if e<=0:
